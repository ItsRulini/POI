...
<html lang="es">
    ...
    <body>
        ...
        <%
            ...
            HashSet<Chat> listaChats = (HashSet<Chat>) request.getSession().getAttribute("ListaChats");
            ...
            <div class="sidebar">
                ...
                <div class="chats-display">
                    ...
                    <div class="chats-active"> <!-- container principal del chat -->
                        ...
                        <div class="user-convo">
                            <p class="username">No tienes ninguna conversación</p>
                            <p class="conversation">Agrega una en el botón de '+'</p>
                        </div>
